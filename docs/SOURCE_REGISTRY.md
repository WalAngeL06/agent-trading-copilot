...
ingestion topic. The next product tasks are API contract and real runtime MCP,
only after explicit Ch.1 approval; see [NEXT_TASK](NEXT_TASK.md).
...
Ch.0 freezes scope/memory and prepares Git worktrees; it starts no implementation.
